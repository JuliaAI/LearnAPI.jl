...
| [`LearnAPI.load_path`](@ref)`(algorithm)`                             | a string locating the name of `LearnAPI.constructor(algorithm)` is defined, beginning with a package name                | "unknown"`                                            | `FastTrees.LearnAPI.DecisionTreeClassifier`                |
